...
export default function MigratePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-8">
      {/* Header */}
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-4 mb-8">
        <div className="flex items-center gap-4 w-full md:w-auto">
          <button 
            onClick={() => router.back()}
            className="p-2 hover:bg-white/10 rounded-full transition text-gray-400 hover:text-white shrink-0"
          >
            ← Back
          </button>
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-white">Dataset Migration Tool</h1>
            <p className="text-gray-400 text-sm md:text-base">Sunrise/BIO Provenance Pipeline</p>
          </div>
        </div>
